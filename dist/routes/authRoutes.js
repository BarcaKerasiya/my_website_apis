...
router.post("/login", (0, asyncErrorHandler_1.asyncHandler)(authController_1.authUser));
router.post("/refresh-token", (0, asyncErrorHandler_1.asyncHandler)(authController_1.refreshAccessToken));
